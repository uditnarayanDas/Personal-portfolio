...
export const metadata: Metadata = {
  title: "Blog — Udit Narayan Das",
  description: "Thoughts, tutorials, and articles by Udit Narayan Das on web development, design systems, and modern engineering.",
};
    ...
    <main className="relative min-h-screen w-full bg-black flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center space-y-6 px-6">
        ...
        <p className="text-neutral-500 text-sm max-w-sm leading-relaxed">
          Articles and writings on development, design, and the craft of building for the web are coming.
        </p>
        <Link
          href="/"
